...
public class TimelineView extends View {
    ...
    private void init(AttributeSet attrs) {
        ...
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.timeline);

        mMarkerSize = a.getDimensionPixelSize(
                R.styleable.timeline_markersize,
                mMarkerSize);

        mLineSize = a.getDimensionPixelSize(
                R.styleable.timeline_linesize,
                mLineSize);

        mBeginLine = a.getDrawable(
                R.styleable.timeline_beginline);

        mEndLine = a.getDrawable(
                R.styleable.timeline_endline);

        mMarkerDrawable = a.getDrawable(
                R.styleable.timeline_marker);
